...
import demo.test.kdxfvoice.util.FucUtil;
import demo.test.kdxfvoice.util.JsonParser;
import demo.test.kdxfvoice.util.XmlParser;

public class LixianyuyinShiBieActivity extends AppCompatActivity {

    private static String TAG = LixianyuyinShiBieActivity.class.getSimpleName();
    // 语音识别对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lixianyuyin_shi_bie);
